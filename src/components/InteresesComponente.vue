...
const intereses = ref([
    'Desarrollo de software de código abierto: Participo en proyectos en GitHub y colaboro con otros desarrolladores para mejorar herramientas y librerías.',
    'Música e instrumentos: Disfruto de tocar guitarra y bajo, actividades que estimulan mi creatividad y me permiten mantener un buen equilibrio personal.',
    'Backend y APIs: Me interesa el desarrollo de APIs, la arquitectura de software y las nuevas tendencias tecnológicas como la inteligencia artificial.',
    'Deporte y gimnasio: Entrenar regularmente me ayuda a mantener disciplina, enfoque y un equilibrio saludable entre la vida personal y profesional.'
]);
